...
function TypeSelectionForm({ register, userType, setUserType }: Props) {
  return (
    <>
      ...
      <UserTypeCard register={register} setUserType={setUserType} userType={userType} value="owner" title="I am a Student" text="Setting up my acccount for my company."></UserTypeCard>
    </>
  );
}
